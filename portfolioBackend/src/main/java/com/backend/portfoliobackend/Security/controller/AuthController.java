package com.backend.portfoliobackend.Security.controller;
...
import com.backend.portfoliobackend.Security.interdto.JwtDto;
import com.backend.portfoliobackend.Security.interdto.LoginUsuario;
import com.backend.portfoliobackend.Security.interdto.NuevoUsuario;
import com.backend.portfoliobackend.Security.jwt.JwtProvider;
import com.backend.portfoliobackend.Security.service.RolService;
import com.backend.portfoliobackend.Security.service.UserDetailsServiceImpl;
import com.backend.portfoliobackend.Security.service.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult) {
        if (bindingResult.hasErrors())
            return new ResponseEntity("Campos erróneos o email invalido", HttpStatus.BAD_REQUEST);
